...
import nathanelucas.findmyschool.Activities.AuthActivities.EmailAuthActivity;
import nathanelucas.findmyschool.Activities.AuthActivities.FacebookAuthActivity;
import nathanelucas.findmyschool.Activities.AuthActivities.GoogleAuthActivity;
...
public class LoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener{
    ...
    //Views
    private final int signEmail = R.id.emailBtn;
    private final int signGoogle = R.id.gBtn;
    private final int createUserEmail = R.id.createAccount;
